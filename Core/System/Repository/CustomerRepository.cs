...
namespace Core.System.Repository
{
    public class CustomerRepository
    {
        ...
        {
            string query = "UPDATE customer SET `status` = '0' WHERE id = @id";
            upgradeManager = new UpgradeManager();
